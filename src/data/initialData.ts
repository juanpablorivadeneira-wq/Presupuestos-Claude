...
export const initialItems: Item[] = [
  {
    ...
    description: 'Cemento gris para construcción general',
    unit: 'kg',
    material: 0.45,
    manoDeObra: 0,
    equipo: 0,
    indirectos: 0.05,
    categoryId: 'cat-mat-og',
  },
  {
    id: 'item-2',
    code: 'MAT-OG-002',
    name: 'Arena de Río',
    description: 'Arena lavada para mezclas',
    unit: 'm³',
    material: 25.0,
    manoDeObra: 0,
    equipo: 0,
  ...
  },
  {
    ...
    description: 'Bloque hueco para mampostería',
    unit: 'Und',
    material: 0.85,
    manoDeObra: 0,
    equipo: 0,
  ...
  },
  {
    id: 'item-4',
    code: 'MAT-AC-001',
    name: 'Adoquin Español 8cm Color 30x14',
    description: 'Adoquín decorativo para exteriores',
    unit: 'm²',
    material: 17.51,
    manoDeObra: 0,
    equipo: 0,
    indirectos: 1.5,
    categoryId: 'cat-mat-ac',
  },
  {
    id: 'item-5',
    code: 'MAT-AC-002',
    name: 'Adoquin Modena 8 cm Color',
    description: 'Adoquín tipo modena',
    unit: 'm²',
    material: 19.15,
    manoDeObra: 0,
    equipo: 0,
  ...
  },
  {
    id: 'item-6',
    code: 'MAT-AC-003',
    name: 'Cerámica Piso 45x45 cm',
    description: 'Cerámica esmaltada antideslizante',
    unit: 'm²',
    material: 12.5,
    manoDeObra: 0,
    equipo: 0,
  ...
  },
  {
    id: 'item-7',
    code: 'MAT-HE-001',
    name: 'Amoladora Dewalt DWE4559 2400W',
    ...
    equipo: 0,
    indirectos: 10.0,
    categoryId: 'cat-mat-he',
  },
  {
    id: 'item-8',
    code: 'MAT-HE-002',
    name: 'Taladro Percutor 13mm 850W',
  ...
  },
  {
    ...
    description: 'Casco duro con suspensión',
    unit: 'Und',
    material: 8.5,
    manoDeObra: 0,
    equipo: 0,
    indirectos: 0.85,
    categoryId: 'cat-mat-epp',
  },
  {
    id: 'item-10',
    code: 'MO-001',
    name: 'Peón de Construcción',
    description: 'Trabajador no calificado',
    unit: 'h',
    material: 0,
    manoDeObra: 3.5,
    equipo: 0,
  ...
  },
  {
    ...
    description: 'Trabajador calificado',
    unit: 'h',
    material: 0,
    manoDeObra: 6.5,
    equipo: 0,
  ...
  },
  {
    ...
    code: 'MO-003',
    name: 'Albañil',
    description: 'Oficial de construcción',
    unit: 'h',
    material: 0,
    manoDeObra: 4.5,
    equipo: 0,
  ...
  },
  {
    id: 'item-14',
    code: 'EQ-002',
    name: 'Compactadora Vibradora',
    description: 'Compactador de suelo manual',
    unit: 'h',
    material: 0,
    manoDeObra: 0,
    equipo: 12.0,
  ...
  },
  {
    ...
    description: 'Red de agua potable y alcantarillado',
    unit: 'Global',
    material: 0,
    manoDeObra: 0,
    equipo: 0,
  ...
  },
  {
    ...
    code: 'MO-004',
    name: 'Electricista',
    description: 'Técnico en instalaciones eléctricas',
    unit: 'h',
    material: 0,
    manoDeObra: 8.0,
    equipo: 0,
...
export const initialRubros: Rubro[] = [
  {
    id: 'rubro-1',
    code: '02.01.02',
    name: 'Pruebas de Compactación',
    description: 'Ensayo de compactación de suelos',
    unit: 'Global',
    components: [
  ...
  },
  {
    ...
    description: 'Trabajos de nivelación y conformación',
    unit: 'm²',
    components: [
  ...
  },
  {
    id: 'rubro-3',
    code: '02.02.01',
    name: 'Excavaciones y Rellenos con Material de Sitio',
    description: 'Movimiento de tierra con maquinaria',
    unit: 'm³',
    components: [
  ...
  },
  {
    id: 'rubro-4',
    code: '02.02.02',
    name: 'Excavaciones y Rellenos con Material Pétreo',
    description: 'Relleno con material importado',
    unit: 'm³',
    components: [
  ...
  },
  {
    id: 'rubro-5',
    code: '02.02.03',
    name: 'Cajas de Revisión de 60x60',
    description: 'Construcción de caja de inspección',
    unit: 'Und',
    components: [
